#!/bin/bash
# =============================================================
# SALMONELLA — SCRIPT 01: GENE EXTRACTION (ABRicate)
...
# NOTE:   Salmonella uses BOTH CARD and ResFinder databases.
#         This differs from E. coli (CARD only).
# =============================================================
...
{
echo "============================================================"
echo "SALMONELLA SCRIPT 01: GENE EXTRACTION"

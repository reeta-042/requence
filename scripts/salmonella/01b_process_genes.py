#!/usr/bin/env python3
# =============================================================
# SALMONELLA — SCRIPT 01b: PROCESS GENE EXTRACTION OUTPUT
...
# NOTE:   Salmonella collapses TWO database rows (CARD + ResFinder)
#         into one binary genome row using a union (max) rule.
# =============================================================
...
with open(LOG_FILE, "w") as fh:
    fh.write("=" * 60 + "\n")
    fh.write("SALMONELLA SCRIPT 01b: PROCESS GENE EXTRACTION\n")
